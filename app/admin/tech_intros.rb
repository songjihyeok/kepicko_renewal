ActiveAdmin.register TechIntro do
  menu parent: "level0"
  ...
  #
  # permit_params :title, :image, :sub_title, :description, :level1_id, :level0_id
  #
  # or
  #
  # permit_params do
  #   permitted = [:title, :image, :sub_title, :description, :level1_id, :level0_id]
  ...
  permit_params :title, :image, :description, :level1_id, :level0_id
end
